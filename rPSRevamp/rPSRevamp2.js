...
console.log(chalk.greenBright.bold("The rules are simple, if you win your score goes up and you go in to the next round, the more you win\n the more your counter goes up, BUT if you lose at least one round\n your score goes back to zero and you are kicked from the game 😈"))
...
let usrNameInput = readlineSync.question("Before we start I need to know your name: ")
console.log()
console.log(`Hello ${usrNameInput}, nice to meet you, get ready to lose by the way 🙄.`)

let usrOpts = ['Rock', 'Paper', 'Scissors']

console.log(`I hope you're ready ${usrNameInput}, I'm really good at this game 🙄`)
...
console.log(chalk.cyanBright.bold.underline(`You threw ${usrChoice}, I threw ${computerChoice}.`))
...
switch(computerChoice2){
    ...
    let startGame2 = readlineSync.keyInSelect(usrOpts2, 'Rock, paper, scissors!');
