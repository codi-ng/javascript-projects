...
function _questionNum(query, options, parser) {
  ...
  exports.question(query, margeOptions({
    // -------- default
    limitMessage:       'Input a valid number.'
  }, options, {
    // -------- forced
    limit:              getValidValue,
    cd:                 false
...
exports.keyInSelect = function(items, query, options) {
  ...
  // if (!options || options.cancel !== false) { 
    ...
    UN COMMENT THIS ^^^^ IF STATEMENT IF YOU WANT THE [0] CANCEL OPTION IN KEY IN SELECT, LEAVE IT COMMENTED FOR STRICT DECISION MAKING
